  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-foreground text-foreground bg-background rounded-full hover:bg-accent/60',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/90',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'text-primary underline-offset-4 hover:underline',
        pill: 'border border-foreground text-foreground bg-background rounded-full hover:bg-muted',
        pillActive: 'border border-foreground text-foreground bg-muted rounded-full hover:bg-muted',
      },
      size: {
