 ...
 * Comprehensive admin panel with analytics, metrics, and management tools
 */
export default function AdminPage() {
  ...
  // Force loading to false in development mode
  useEffect(() => {
    setLoading(false)
    setIsAdmin(true)
  }, [])
  ...
  useEffect(() => {
    // Load mock admin data without auth
    loadAdminData()
  }, [])
  ...
  const userGrowthData = [
    ...
    { month: 'May', users: 2180, growth: 14 },
    { month: 'Jun', users: 2450, growth: 12 },
  ]

  const revenueData = [
    { month: 'Jan', revenue: 8500, growth: 8 },
    { month: 'Feb', revenue: 9200, growth: 8 },
    { month: 'Mar', revenue: 10100, growth: 10 },
    { month: 'Apr', revenue: 11200, growth: 11 },
    { month: 'May', revenue: 12400, growth: 11 },
    { month: 'Jun', revenue: 13800, growth: 11 },
  ]
    ...
    <>
      ...
      <div className="flex-1 flex flex-col ml-64">
        ...
        <main className="flex-1 p-6 overflow-auto mt-16">
          {/* Welcome Section */}
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-foreground mb-2">Welcome back, {userProfile?.title || 'Admin'}!</h2>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="mt-4 text-center">
                    <p className="text-sm text-muted-foreground">User growth over the last 6 months</p>
                  </div>
                </CardContent>
              </Card>
            </div>
